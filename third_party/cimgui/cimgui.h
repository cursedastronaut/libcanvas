...
CIMGUI_API bool igListBoxHeader_Vec2(const char* label,const ImVec2 size);
CIMGUI_API bool igListBoxHeader_Int(const char* label,int items_count,int height_in_items);
